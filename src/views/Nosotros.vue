<template>
  <q-page class="bg-grey-10 text-grey-2 q-pb-xl">
    ...
    <div class="banner-container relative-position">
      <q-img src="https://images.unsplash.com/photo-1555396273-367ea4eb4db5?q=80&w=1200&auto=format&fit=crop" height="320px" fit="cover">
    ...
    <div class="container q-mx-auto q-px-md q-mt-xl" style="max-width: 1100px;">
      ...
      <div class="q-mb-xl">
        <q-card class="bg-grey-9 text-grey-2 shadow-24 border-gold border-radius-lg overflow-hidden">
          <div class="row no-wrap border-responsive items-center">
            <q-img src="https://images.unsplash.com/photo-1577219491135-ce391730fb2c?q=80&w=700&auto=format&fit=crop" class="col-12 col-md-6" height="380px" fit="cover" />
            <q-card-section class="col-12 col-md-6 q-pa-xl">
              ...
              <h2 class="text-h4 text-weight-bolder text-amber-1 playfair-font q-mb-md">El Arte de la Cocina de Autor</h2>
              <p class="text-body1 text-grey-4 font-light q-mb-sm">
                Nacimos con el propósito de redefinir los clásicos de la cocina urbana y tradicional, elevándolos mediante técnicas vanguardistas y materia prima de la más alta calidad.
              </p>
              <p class="text-body2 text-grey-5 font-light">
                Cada receta es diseñada minuciosamente por nuestro equipo de chefs, donde la temperatura, la textura y el maridaje perfecto son los protagonistas.
              </p>
            </q-card-section>
          </div>
        </q-card>
      ...
      <div class="row q-col-gutter-lg q-mb-xl">
        <div v-for="(pilar, index) in pilares" :key="index" class="col-12 col-sm-4">
          <q-card class="card-gourmet bg-grey-9 text-grey-2 full-height flex flex-center column text-center q-pa-lg border-grey border-radius-md">
...
<div class="row q-col-gutter-lg items-stretch">
  <div v-for="(miembro, index) in equipo" :key="index" class="col-12 col-sm-6 col-md-4">
    <q-card class="card-gourmet bg-grey-9 text-grey-2 full-height border-grey border-radius-md overflow-hidden flex column justify-between">
      
      <!-- Contenedor superior: Imagen fija -->
      <div>
        <q-img 
          :src="miembro.imagen" 
          height="280px" 
        ...
        <q-card-section class="text-center">
          ...
          <div class="text-caption text-amber-5 text-bold text-uppercase letter-spacing-2 q-mb-xs">{{ miembro.cargo }}</div>
